  ...
  <body>
    ...
    <div id='addressBook'>
      ...
      while($address = mysqli_fetch_assoc($addresses)) {
        echo '<form class="address col-md-3" id="address" method="get">
          ...
          <button class="btn btn-default" type="submit" formaction="/editAddress.php?id='.$address["address_id"].'">Edit</button>
          <button class="btn btn-default" type="submit" formaction="/deleteAddress.php?id='.$address["address_id"].'">Delete</button>
        </form>';
      }
      ?>
    </div>
